<template>
  <div
    class="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center p-4 overflow-hidden"
  >
    <div class="relative w-full max-w-3xl bg-white shadow-lg rounded-lg overflow-hidden">
      ...
      <div class="flex w-full h-auto">
        ...
        <div class="flex-1 flex flex-col justify-center items-center bg-white p-14">
          <h2 class="text-3xl font-semibold mb-6">Login Account</h2>

          <form class="w-full max-w-md space-y-5">
            <div>
              <label class="block text-lg font-bold mb-1">Username</label>
            ...
            <div>
              <label class="block text-lg font-bold mb-1">Password</label>
            ...
            <p class="text-right text-blue-500 cursor-pointer hover:underline">
            ...
            <div class="flex justify-around gap-5">
              <button
                class="flex-1 p-4 bg-blue-600 text-white rounded hover:bg-blue-700 transition"
              >
                Facebook
              </button>

              <button class="flex-1 p-4 bg-red-500 text-white rounded hover:bg-red-600 transition">
                Google
              </button>
            </div>
