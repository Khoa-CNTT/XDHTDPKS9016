  ...
  <div class="content relative bg-gradient-primary">
    <div class="hero text-center min-h-[350px] flex flex-col justify-center bg-text">
      <h1 class="text-3xl text-white font-bold">
        Tìm & đặt phòng khách sạn với <br />các bước đơn giản!
      </h1>

      <p class="text-lg text-white mt-2">
        Khám phá ngay những ưu đãi tốt nhất dành cho bạn tại <b>Booking</b>!
      </p>
    </div>

    <div
      class="search-box grid grid-cols-1 md:grid-cols-5 gap-4 p-4 bg-white shadow-lg w-10/12 md:w-3/4 mx-auto absolute top-80 left-0 right-0 border border-gray-300 rounded-lg"
    >
      ...
      <button
        class="search-btn bg-orange-400 text-white py-1 px-2 text-sm rounded-md hover:bg-orange-300"
      >
        Tìm kiếm
      </button>
    </div>
