<template>
  <div class="p-8 bg-gradient-to-r from-gray-100 to-blue-100">
    <div class="container mx-auto px-8 grid grid-cols-1 md:grid-cols-3 gap-6 py-2">
      ...
      <div class="md:col-span-2 space-y-6">
        ...
        <div class="flex gap-4">
          ...
          <div class="w-1/3 grid grid-cols-2 gap-2">
            <img
              src="/assets/images/img-hotel-6.jpeg"
        ...
        <div class="bg-white p-6 rounded-lg shadow-lg">
          ...
          <p class="text-text leading-relaxed">
            La Vela Saigon Hotel là khách sạn 5 sao sang trọng, tọa lạc ngay trung tâm TP. Hồ Chí
            Minh, mang đến không gian nghỉ dưỡng hoàn hảo với phong cách thiết kế tinh tế, đẳng cấp.
            Với vị trí thuận lợi, du khách có thể dễ dàng di chuyển đến các địa điểm nổi tiếng như
            Nhà thờ Đức Bà, Chợ Bến Thành hay Phố đi bộ Nguyễn Huệ.

            <br /><br />

            Khách sạn cung cấp hệ thống phòng nghỉ đa dạng từ tiêu chuẩn đến cao cấp, mỗi phòng đều
            được thiết kế theo phong cách hiện đại, kết hợp với nội thất sang trọng, tạo nên một
            không gian nghỉ dưỡng thoải mái và tiện nghi. Đặc biệt, phòng có tầm nhìn bao quát thành
            phố, giúp du khách tận hưởng khung cảnh tuyệt đẹp về đêm.

            <br /><br />

            Một trong những điểm nhấn của La Vela Saigon Hotel chính là hồ bơi vô cực trên tầng
            thượng, nơi du khách có thể thư giãn trong làn nước mát lạnh và chiêm ngưỡng toàn cảnh
            thành phố từ trên cao. Ngoài ra, khách sạn còn có hệ thống nhà hàng sang trọng phục vụ
            các món ăn Á - Âu đa dạng, quầy bar với không gian lãng mạn, trung tâm spa cao cấp giúp
            bạn thư giãn sau những giờ làm việc căng thẳng.

            <br /><br />

            Đối với những ai yêu thích thể thao và chăm sóc sức khỏe, phòng gym hiện đại được trang
            bị đầy đủ thiết bị luyện tập sẽ là một lựa chọn lý tưởng. Bên cạnh đó, trung tâm hội
            nghị với sức chứa lớn, trang bị hệ thống âm thanh, ánh sáng hiện đại sẽ là địa điểm lý
            tưởng để tổ chức các sự kiện, hội nghị hay tiệc cưới đẳng cấp.

            <br /><br />

            Đội ngũ nhân viên chuyên nghiệp, tận tình luôn sẵn sàng phục vụ 24/7, đảm bảo mang đến
            cho du khách những trải nghiệm đáng nhớ nhất. Nếu bạn đang tìm kiếm một nơi lưu trú hoàn
            hảo với dịch vụ đẳng cấp, La Vela Saigon Hotel chính là lựa chọn lý tưởng cho bạn.
          </p>
      ...
      <div class="bg-white p-6 rounded-lg shadow-lg">
        ...
        <div class="space-y-4">
          ...
          <div class="bg-white rounded-lg shadow-md hover:scale-105 transition">
            <img
              src="/assets/images/img-hotel-2.png"
              class="w-full h-32 object-cover rounded-t-lg"
            />
          ...
          <div class="bg-white rounded-lg shadow-md hover:scale-105 transition">
            <img
              src="/assets/images/img-hotel-3.png"
              class="w-full h-32 object-cover rounded-t-lg"
            />
          ...
          <div class="bg-white rounded-lg shadow-md hover:scale-105 transition">
            <img
              src="/assets/images/img-hotel-4.png"
              class="w-full h-32 object-cover rounded-t-lg"
            />
          ...
          <div class="bg-white rounded-lg shadow-md hover:scale-105 transition">
            <img
              src="/assets/images/img-hotel-5.png"
              class="w-full h-32 object-cover rounded-t-lg"
            />
    ...
    <div class="container mx-auto px-8 pt-4">
      ...
      <table
        class="w-full border-collapse border border-gray-800 mt-2 text-sm md:text-base text-center"
      >
        <thead>
      ...
      <div class="bg-white text-gray-800 p-5 rounded-lg shadow-md">
        ...
        <ul class="space-y-3">
          <li class="flex items-center gap-3">
            <span class="text-green-500 text-xl">✅</span> Giảm
            <span class="text-red-500 font-bold">20%</span> khi đặt phòng online
          </li>

          <li class="flex items-center gap-3">
            <span class="text-green-500 text-xl">✅</span> Tặng
            <span class="text-blue-500 font-bold">buffet sáng miễn phí</span>
          </li>
    ...
    <div class="container mx-auto px-6 py-2 my-6 text-white text-center">
      <div class="bg-text text-gray-800 p-5 rounded-lg shadow-md">
        <h2
          class="text-2xl font-bold text-white tracking-wide mb-4 flex items-center justify-center gap-2"
        >
          🏨 Đặt phòng ngay 📅
        </h2>
...
const reviews = ref([
...

  {
    id: 2,
    name: 'Trần Thị B',
    comment: 'Phòng sạch sẽ, view đẹp, nhân viên nhiệt tình. Sẽ quay lại!',
  },
