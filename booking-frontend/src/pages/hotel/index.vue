      ...
      <main class="grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        >
          ...
          >
            <div
              ...
              :key="index"
              class="flex flex-row items-start bg-blue-50 hover:bg-blue-100 transition p-3 rounded-lg cursor-pointer h-auto"
            ...
            >
              ...
              <div class="flex-1 flex flex-col">
                <h3 class="text-sm font-semibold text-blue-700 hover:underline">
                  {{ hotel.name }}
                </h3>
        ...
        <section class="col-span-1 md:col-span-3 space-y-6">
          <article
            ...
            :key="index"
            class="flex flex-col md:flex-row bg-white rounded-3xl border border-indigo-200 shadow-lg hover:shadow-2xl transition overflow-visible h-auto"
          >
            <!-- Hình ảnh -->
            ...
            <!-- Nội dung -->
            <div class="flex-1 p-5 bg-gradient-to-r from-white to-indigo-50 flex flex-col">
              <h2
...
// Tự động gọi API khi location thay đổi
