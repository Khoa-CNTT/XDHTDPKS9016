            ...
            <div class="sidebar">
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column space-y-1">
                        <li class="nav-item">
                            <router-link to="/supplier/room-management" class="nav-link d-flex align-items-center gap-2 text-white font-bold">
                                <Icon icon="material-symbols:hotel-class-rounded" width="24" height="24" />
                                <p class="mb-0">Quản lý đặt phòng</p>
                            </router-link>
                        </li>
                        <li class="nav-item">
                            <router-link to="/supplier/service-control" class="nav-link d-flex align-items-center gap-2 text-white font-bold">
                                <Icon icon="carbon:service-desk" width="24" height="24" />
                                <p class="mb-0">Quản lý dịch vụ</p>
                            </router-link>
                        </li>
                        <li class="nav-item">
                            <router-link to="/supplier/review-manage" class="nav-link d-flex align-items-center gap-2 text-white font-bold">
                                <Icon icon="mdi:comment-multiple-outline" width="24" height="24" />
                                <p class="mb-0">Quản lý bình luận</p>
                            </router-link>
                        </li>
                        <li class="nav-item">
                            <router-link to="/supplier/overview-report" class="nav-link d-flex align-items-center gap-2 text-white font-bold">
                                <Icon icon="mdi:chart-box-outline" width="24" height="24" />
                                <p class="mb-0">Báo cáo và thống kê</p>
                            </router-link>
                        </li>
                        <li class="nav-item">
                            <router-link to="/supplier/profile-settings" class="nav-link d-flex align-items-center gap-2 text-white font-bold">
